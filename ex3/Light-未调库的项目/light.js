...
var fcolor;
var points;
//number of values used for points
var num;
//number of points
var points_num;
...
var materialAmbients = [ vec4( 0.24725, 0.1995, 0.0745, 1.0 ),      //gold
                        vec4( 0.19225, 0.19225, 0.19225, 1.0 ),    //silver
						vec4( 0.05, 0.05, 0.0, 1.0 ),              //yellow rubber
						];
						
var materialDiffuses = [ vec4( 0.75164, 0.60648, 0.22648, 1.0 ),
...
window.onload = function init() {
	...
	document.getElementById("moveBackword").onclick = function(event) {
		moveMatrix = mat4();
		moveMatrix[0][3] -= step;
		cmt = mult(moveMatrix, cmt);
    };
